...
<section id="produccion" class="fullscreen videos bg-hero bg-endh">
    <video autoplay="" class="video-bg" muted="muted" loop="" src="assets/videos/endh-bg.mp4" webkit-playsinline="" playsinline="" id="loadvideo"></video>
